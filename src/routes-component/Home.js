...
function Home() {
  return (
    <div className={styles.home} data-testid="user-id">
      ...
      <p>
        ...
        was the “Cal Tech”, launched in 1967 by Texas Instruments. It was
        capable of performing all four basic operations, but cost over $200,
        making it a luxury item at the time. Over the years, calculators have
        become more and more sophisticated and affordable. Scientific
